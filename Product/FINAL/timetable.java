...
public class timetable
{
    public static String[] readfromfile()
    {
        ...
        try
        {
            ...
            {
                System.out.println("THAT IS NOT A .CSV (╯°□°）╯︵ ┻━┻");
                System.out.println("The answer: " + answer + " did not contain the characters .csv and is therefore not a valid file.");
                return null;
            }
            ...
            try
            {
            	...
            	reader.readLine(); //skip line 1 as that contains headings for usability
        ...
        finally 
        {
            try 
            {
                ...
                return studentarray; //return the raw, unparsed data
            } 
            catch (IOException e)
            {
                System.out.println("IO Exception error (╯°□°）╯︵ ┻━┻");
